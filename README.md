...
After publication, paste this into Codex, ZCode, Claude Code, Claude Desktop Code, or WorkBuddy:
...
After GitHub Pages is enabled with GitHub Actions as its publishing source, the
same original demo is available at [yulaiz.github.io/interactive-code-map](https://yulaiz.github.io/interactive-code-map/).
