...
function usage() {
  console.error('用法: node tests/e2e/run-e2e.mjs --repo-root <证据根目录：代码仓库或业务资料目录> [--mapspec <文件>] [--html <相对 HTML>]');
}
...
try {
  ...
  console.log('1. 以该证据根（代码仓库或业务资料目录）和业务问题运行 skill 工作流，先收集证据并生成 MapSpec。');
